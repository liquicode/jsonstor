```
  ...
  400) jsonstor-userinfo Tests
    A) CRUD Tests
      ...
      ✔ should replace 100 documents, one at a time (34ms)
      ✔ should read 100 documents, all at once
      ✔ should update 100 documents, one at a time (27ms)
      ✔ should update 100 documents, all at once (16ms)
  ...
  100) jsonstor-memory Tests
    A) CRUD Tests
      ...
      ✔ should replace 100 documents, one at a time (20ms)
      ✔ should read 100 documents, all at once
  ...
  200) jsonstor-folder Tests
    A) CRUD Tests
      ✔ should insert 100 documents, one at a time (129ms)
      ✔ should delete 100 documents, all at once (65ms)
      ✔ should insert 100 documents, all at once (123ms)
      ✔ should read 100 documents, one at a time (525ms)
      ✔ should replace 100 documents, one at a time (1293ms)
      ✔ should read 100 documents, all at once (10ms)
      ✔ should update 100 documents, one at a time (819ms)
      ✔ should update 100 documents, all at once (106ms)
      ✔ should delete 100 documents, one at a time (80ms)
    B) Rainbow Tests
      Nested Fields (explicit)
    ...
    C) UserInfo Permissions Tests
      Alice, Bob, and Eve scenario
        ✔ Should add documents and set permissions (38ms)
        ✔ Alice should read all documents and write all documents (93ms)
        ✔ Bob should read some documents and write some documents (70ms)
        ✔ Eve should read some documents and write some documents (53ms)
        ✔ Public objects should be readable by everyone (49ms)
        ✔ Public objects should only be writable by the owner (45ms)
        ✔ Should not allow readers to update documents (50ms)
    C) MongoDB Tutorial
      Query Documents (https://www.mongodb.com/docs/manual/tutorial/query-documents/)
        Select All Documents in a Collection
    ...
    D) MongoDB Reference
      Comparison Query Operators
        ...
        Comparison Operator: $gte (https://www.mongodb.com/docs/manual/reference/operator/query/gte/)
          ✔ Match Document Fields
        Comparison Operator: $in (https://www.mongodb.com/docs/manual/reference/operator/query/in/)
          ✔ Use the $in Operator to Match Values (7ms)
          ✔ Use the $in Operator to Match Values in an Array
          ✔ Use the $in Operator with a Regular Expression
        Comparison Operator: $lt (https://www.mongodb.com/docs/manual/reference/operator/query/lt/)
          ✔ Match Document Fields (6ms)
      ...
      Array Query Operators
        Array Query Operator: $all (https://www.mongodb.com/docs/manual/reference/operator/query/all/)
          ✔ Use $all to Match Values (7ms)
          ✔ Use $all with $elemMatch
          ✔ Use $all with Scalar Values
        Array Query Operator: $elemMatch (https://www.mongodb.com/docs/manual/reference/operator/query/elemMatch/)
          ✔ Element Match (10ms)
          ✔ Array of Embedded Documents (12ms)
  ...
  300) jsonstor-jsonfile Tests
    A) CRUD Tests
      ✔ should insert 100 documents, one at a time (695ms)
      ✔ should delete 100 documents, all at once (6ms)
      ✔ should insert 100 documents, all at once
      ✔ should read 100 documents, one at a time (21ms)
      ✔ should replace 100 documents, one at a time (727ms)
      ✔ should read 100 documents, all at once
      ✔ should update 100 documents, one at a time (726ms)
      ✔ should update 100 documents, all at once (7ms)
      ✔ should delete 100 documents, one at a time (713ms)
    B) Rainbow Tests
      Nested Fields (explicit)
        ✔ should not perform matching on nested fields using implicit $eq
        ✔ should not perform matching on nested fields using explicit $eq
    ...
    C) UserInfo Permissions Tests
      Alice, Bob, and Eve scenario
        ✔ Should add documents and set permissions (69ms)
        ✔ Alice should read all documents and write all documents (107ms)
        ✔ Bob should read some documents and write some documents (86ms)
        ✔ Eve should read some documents and write some documents (72ms)
        ✔ Public objects should be readable by everyone (70ms)
        ✔ Public objects should only be writable by the owner (70ms)
        ✔ Should not allow readers to update documents (70ms)
    C) MongoDB Tutorial
      Query Documents (https://www.mongodb.com/docs/manual/tutorial/query-documents/)
        Select All Documents in a Collection
          ✔ Match All Documents with an Empty Object {}
