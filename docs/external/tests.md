```
  ...
  200) jsonstor-folder Tests
    A) CRUD Tests
      ...
      ✔ should read 100 documents, one at a time (523ms)
      ✔ should replace 100 documents, one at a time (1285ms)
      ✔ should read 100 documents, all at once (11ms)
      ✔ should update 100 documents, one at a time (766ms)
      ✔ should update 100 documents, all at once (112ms)
      ✔ should delete 100 documents, one at a time (79ms)
    B) Rainbow Tests
      Nested Fields (explicit)
    ...
    C) UserInfo Permissions Tests
      Alice, Bob, and Eve scenario
        ...
        ✔ Alice should read all documents and write all documents (100ms)
        ...
        ✔ Public objects should only be writable by the owner (47ms)
        ✔ Should not allow readers to update documents (55ms)
    C) MongoDB Tutorial
      Query Documents (https://www.mongodb.com/docs/manual/tutorial/query-documents/)
        Select All Documents in a Collection
          ✔ Match All Documents with an Empty Object {} (8ms)
        Specify Equality Condition
          ✔ Match Fields with Implicit Equality
        Specify Conditions Using Query Operators
          ✔ Match Fields with an Array of Possible Values
    ...
    D) MongoDB Reference
      ...
      Array Query Operators
        ...
        Array Query Operator: $size (https://www.mongodb.com/docs/manual/reference/operator/query/size/)
          ✔ Use $size to Match Array Sizes (16ms)
    Z) Ad-Hoc Tests
      ✔ should not match explicit nested fields (10ms)

  300) jsonstor-jsonfile Tests
    A) CRUD Tests
      ✔ should insert 100 documents, one at a time (708ms)
      ✔ should delete 100 documents, all at once (6ms)
      ✔ should insert 100 documents, all at once
      ✔ should read 100 documents, one at a time (20ms)
      ✔ should replace 100 documents, one at a time (711ms)
      ✔ should read 100 documents, all at once
      ✔ should update 100 documents, one at a time (777ms)
      ✔ should update 100 documents, all at once (8ms)
      ✔ should delete 100 documents, one at a time (704ms)
    B) Rainbow Tests
      Nested Fields (explicit)
        ✔ should not perform matching on nested fields using implicit $eq
        ✔ should not perform matching on nested fields using explicit $eq
    ...
    C) UserInfo Permissions Tests
      Alice, Bob, and Eve scenario
        ...
        ✔ Alice should read all documents and write all documents (109ms)
        ✔ Bob should read some documents and write some documents (83ms)
        ✔ Eve should read some documents and write some documents (69ms)
        ✔ Public objects should be readable by everyone (70ms)
        ✔ Public objects should only be writable by the owner (69ms)
        ✔ Should not allow readers to update documents (69ms)
    C) MongoDB Tutorial
      Query Documents (https://www.mongodb.com/docs/manual/tutorial/query-documents/)
        Select All Documents in a Collection
          ✔ Match All Documents with an Empty Object {}
