```
  ...
  200) jsonstor-folder Tests
    A) CRUD Tests
      ✔ should insert 100 documents, one at a time (144ms)
      ✔ should delete 100 documents, all at once (61ms)
      ✔ should insert 100 documents, all at once (122ms)
      ✔ should read 100 documents, one at a time (531ms)
      ✔ should replace 100 documents, one at a time (1273ms)
      ✔ should read 100 documents, all at once (10ms)
      ✔ should update 100 documents, one at a time (761ms)
      ✔ should update 100 documents, all at once (104ms)
      ✔ should delete 100 documents, one at a time (86ms)
    B) Rainbow Tests
      Nested Fields (explicit)
    ...
    D) MongoDB Reference
      Comparison Query Operators
        ...
        Comparison Operator: $nin (https://www.mongodb.com/docs/manual/reference/operator/query/nin/)
          ✔ Select on Unmatching Documents (11ms)
          ✔ Select on Elements Not in an Array
      Logical Query Operators
        Logical Operator: $and (https://www.mongodb.com/docs/manual/reference/operator/query/and/)
      ...
      Array Query Operators
        ...
        Array Query Operator: $size (https://www.mongodb.com/docs/manual/reference/operator/query/size/)
          ✔ Use $size to Match Array Sizes (14ms)
    Z) Ad-Hoc Tests
      ✔ should not match explicit nested fields (10ms)

  300) jsonstor-jsonfile Tests
    A) CRUD Tests
      ✔ should insert 100 documents, one at a time (711ms)
      ✔ should delete 100 documents, all at once (7ms)
      ✔ should insert 100 documents, all at once
      ✔ should read 100 documents, one at a time (24ms)
      ✔ should replace 100 documents, one at a time (760ms)
      ✔ should read 100 documents, all at once
      ✔ should update 100 documents, one at a time (753ms)
      ✔ should update 100 documents, all at once (7ms)
      ✔ should delete 100 documents, one at a time (725ms)
    B) Rainbow Tests
      Nested Fields (explicit)
        ✔ should not perform matching on nested fields using implicit $eq
        ✔ should not perform matching on nested fields using explicit $eq
  ...
  500) UserStorage Storage Tests
    A) CRUD Tests
      ...
      ✔ should read 100 documents, all at once
      ✔ should update 100 documents, one at a time (29ms)
